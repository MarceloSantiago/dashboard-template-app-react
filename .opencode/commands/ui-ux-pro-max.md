...
## OpenCode App Template - Referências
...
|----------|------------|
| Átomos | Button, Badge, Avatar, Input |
| Moléculas | Card, Tabs, Progress, Alert |
| Organismos | Sidebar, Header, Modal, Dropdown |
| Páginas | Login, Settings, UserProfile |

### Skill Principal
`.agent/skills/design-system-starter/SKILL.md`