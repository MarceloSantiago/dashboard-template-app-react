...
| `scripts/validate-dark-mode.cjs` | Dark Mode Tailwind Validation | `node scripts/validate-dark-mode.cjs` |

---

## 🎨 Dark Mode Implementation Rules

> **MANDATORY for Tailwind projects:** Every color class MUST have a corresponding `dark:` variant.

### The Golden Rule
```
Light Mode Class          → Must Always Have
─────────────────────────────────────────────
text-gray-*              → dark:text-gray-* OR dark:text-white
bg-white/bg-gray-*       → dark:bg-boxdark OR dark:bg-gray-800
border-gray-*            → dark:border-strokedark
hover:bg-gray-*          → dark:hover:bg-gray-700
```

### Template Color Variables (TailAdmin)
| Variable | Light Value | Dark Value | Use For |
|----------|------------|------------|---------|
| `boxdark` | #1a2231 | - | Card backgrounds |
| `strokedark` | #2a2f3c | - | Borders |
| `bodydark` | #e2e8f0 | - | Secondary text |
| `meta-4` | #475467 | - | Tertiary elements |

### Quick Dark Mode Checklist
- [ ] Background: `bg-white dark:bg-boxdark`
- [ ] Text headings: `text-black dark:text-white`
- [ ] Text body: `text-gray-* dark:text-gray-*`
- [ ] Borders: `border-gray-* dark:border-strokedark`
- [ ] Hover states: `hover:bg-gray-* dark:hover:bg-gray-700`
- [ ] Selected/Active: `bg-gray-50 dark:bg-gray-700`
